...
- **v4.36.29** - One id per player name across all machines
...
- **v4.36.25** - Firebase config moved to environment variables
...
- **v4.36.1** - Faster fingerprint enrolment; consistent deletedAt field
...
- **v4.35.0** - Fingerprint deletions propagate across machines

- **v4.34.4** - About window checks for updates silently on open
