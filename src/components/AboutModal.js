...
const FIREBASE_PROJECT_ID = 'cuemii-database';
const FIREBASE_CONSOLE_URL = `https://console.firebase.google.com/project/${FIREBASE_PROJECT_ID}/firestore/data`;
        ...
        <div className="p-6">
          ...
          <div className={`rounded-xl border p-3 ${
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`flex items-center justify-center gap-1.5 mt-2 pt-2 border-t text-xs font-medium transition-colors ${
                isDarkMode
